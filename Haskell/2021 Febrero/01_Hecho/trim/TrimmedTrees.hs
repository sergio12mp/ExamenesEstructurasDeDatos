...
trim Empty = Empty
trim (Node a Empty Empty) = Empty
trim (Node a izq der) = Node a (trim izq) (trim der)
...
--
-- To draw the trimmed tree use:
--
-- >>> drawOn "tree4-trimmed.svg" (trim tree4)
