...
/**
 * Union type. Can store either a value of type {@code A} (object is a left value)
 * or a value of type {@code B} (object is a right value), but does not store both
 * values simultaneously. 
 *
 * @param <A> Type of left values.
 * @param <B> Type of right values.
 */
public interface Either<A, B> {
	 ...
	 * @throws NoSuchElementException if object is not a left value.
	 */
	A left();
	 ...
	 * @throws NoSuchElementException if object is not a right value.
	 */
	B right();
}
